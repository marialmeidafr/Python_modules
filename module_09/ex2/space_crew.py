"""
Module for managing and validating crew members and space missions.
"""
...
class Rank(str, Enum):
    """Authorized crew ranks within the fleet."""
    CADET = "cadet"
    OFFICER = "officer"
...
class SpaceMission(BaseModel):
    """Model for space missions containing nested crew member validation."""
    ...
    def check_mission(self) -> 'SpaceMission':
        """Validates mission safety, leadership, and experience requirements."""
...
def main() -> None:
    """Demonstrates space mission validation with nested models."""
    ...
    try:
        ...
        for member in mission.crew:
            print(
                f"- {member.name} ({mission.rank.value}) - "
                f"{mission.specialization}"
            )
